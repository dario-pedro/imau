#ifndef _ARM_ARM_INTERFACE_SIM_HPP__
#define _ARM_ARM_INTERFACE_SIM_HPP__
...
namespace ARM
{
    class Arm_interface_sim : public hardware_interface::RobotHW
    {
        public:

            Arm_interface_sim ();
            virtual ~Arm_interface_sim (){};
